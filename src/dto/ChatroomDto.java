...
public class ChatroomDto {
	...
	private ArrayList<String> listProfileUrl;  // 프로필 이미지 or 색상
	...
	public ChatroomDto(int chatroomIdx, ArrayList<String> listProfileUrl, String chatroomName, String information,
			String chatRecentDateTime, boolean bookmarkYn, int alarm, int unread) {
		this.chatroomIdx = chatroomIdx;
		this.listProfileUrl = listProfileUrl;
	...
	public ArrayList<String> getListProfileUrl() {
		return listProfileUrl;
	}

	public void setListProfileUrl(ArrayList<String> listProfileUrl) {
		this.listProfileUrl = listProfileUrl;
	}
