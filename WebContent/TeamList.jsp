...
<%
	...
	ArrayList<TeamListDto> teamList = mDao.getListTeamListDto(memberIdx);
	MemberDto memberDto = mDao.getMemberDtoByMemberIdx(memberIdx);

	session.setAttribute("memberDto", memberDto);
	session.setAttribute("profilePicUrl", memberDto.getProfilePicUrl());
...
<body>
    ...
    <div id="team-make-main" style="display: none;">
        ...
        <form action="Controller?command=create_team" method="post">
    ...
    <div id="div_header">
        ...
        <div id="div_email" class="fr">
            <img src="<%= session.getAttribute("profilePicUrl") %>">
            <span id="select_email"><%= session.getAttribute("memberName") %></span>
            <div class="dropdown_menu profile_dropdown" style="display: none; visibility: visible;">
                <h5 class="option-title">
                    <span class="option-txt"><span>프로필</span></span>
                </h5>
                <ul class="option-list">
                    <li class="option-item">
                        <i class="option-icon icon-sign-out">
                            <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="24px" fill="#999">
                    ...
                    <li class="option-item">
                        ...
                        <span class="option-txt"><span class="logout">로그아웃</span></span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="div_main">
     <div id="div_profile">
        ...
        <div id="div_team_list_main">
            <div id="div_team_list_txt"><span>팀 리스트</span></div>
            <div class="section-body">
                        ...
                        <div id="div_img_txt">
                            ...
                            <div id="div_main_txt_button" class="fr">
                                ...
                                <div id="div_team_make_button">
                                    <button type="button" class="btn_btn_green">
                                        <span>팀 생성하기</span>
                                    </button>
                                </div>
                            </div>
                ...
                <% } else { %>
                    <ul class="main-team-list">
                        <% for (TeamListDto tDto : teamList) { %>
                            <li class="team-list-li">
                                <dl class="team-card">
                                    <dt><span class="team-name"><%= tDto.getTeamName() %></span></dt>
                                    <dd><%= tDto.getDomain() %></dd>
                                    <dd class="logo-container"><img src="<%= tDto.getTeamImage() %>"></dd>
                                </dl>
            ...
            <div id="div_inner_footer">
                ...
                <div id="div_three_txt" class="fr">
                    <div id="div_QnA" class="fl">
                        <a href="https://support.jandi.com" target="_blank">
                            <span class="ng-scope">자주 묻는 질문</span>
                        </a>
                    </div>
                    <div id="div_private" class="fl">
                        <a href="https://www.jandi.com/landing/kr/private/policy" target="_blank">
                            <span class="ng-scope">개인정보처리방침</span>
                        </a>
                    </div>
                    <div id="div_service" class="fl">
                        <a href="https://www.jandi.com/landing/kr/terms/service" target="_blank">
                            <span class="ng-scope">이용 약관</span>
                        </a>
                    </div>
                    <div style="clear: both;"></div>
                </div>
