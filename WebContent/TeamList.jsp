    ...
    <script>
       $(document).ready(function() {
	        ...
	        $('#div_team_make_button .btn_btn_green, #div_team_make_big .btn_btn_big').click(function() {
	         ...
	         $("#div_set_account").click(function(){
	        	 location.href="Controller?command=enter_account_setting_page"
	         });
	    });
    </script>
</head>
                ...
                <ul class="option-list">
                    <li class="option-item">
                        ...
                        <div class="option-txt">
                            <span class="settings" location.href="Controller?command=enter_account_setting_page">계정 설정</span>
                        </div>
                    </li>
                    <li class="option-item">
                        <i class="option-icon icon-sign-out">
