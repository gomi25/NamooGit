...
/*----확인버튼 눌렀을 때 이메일 발송창 뜨게----*/
			$("#div_find_password_body > div:nth-child(3) > div:nth-child(1)").click(function() { 
				...
				$("#user_email").css('border','1px solid #e0e4ed');
				$("#div_find_password").css('display', 'none');
				$("#div_send_eamil").css('display', 'block');
			});
/*----확인버튼 눌렀을 때 모든 창 꺼지기----*/
			$("#div_send_eamil > div:nth-child(2) input").click(function() { 
				$("#div_send_eamil").css('display', 'none');
				$("#grey_screen").css('display', 'none');
			});
		});
	</script>
...
<!--===========================상단 헤더===============================-->
	<div id="div_header1">
		...
		<div class="fr"><a href="https://www.jandi.com/landing/kr/signin"><strong>로그인</strong></a></div>
...
<!--=============================로그인==============================-->
	<div id="div_body" >
		<div id="div_login">
			<div><h1>로그인</h1></div>
			<form action="namoo_main.html">
<!--______________________________인풋 ______________________________ -->
				<div id="div_email_pw" >
					<div>
...
<!--______________________________체크박스 ___________________________ -->				
...
<!--_________________________비밀번호 변경창 __________________________-->	
	<form action="">
