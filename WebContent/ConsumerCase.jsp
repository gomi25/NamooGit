...
/* 	ArrayList<ConsumerCaseDto> consumerCaseDto = (ArrayList<ConsumerCaseDto>) request.getAttribute("consumerCaseDto");  // 추가
	int industry = (Integer) request.getAttribute("industry"); */
%>
                ...
                <section class="Indusrty_allSection">
                    ...
                    <div class="FilterWithList_filterWithList">
                            ...
                            <div class="FilterWithList_leftSide">
                                <div class="Filters_filters">
                                    <ul class="Filters_filtersList">
                                        ...
                                        <!-- <li data-value="it" class="Filters_filterListItem">IT</li> -->
                                        <li data-value="education" class="Filters_filterListItem <%=(industry==6 ? "Filters_selected" : "")%>">교육</li>
                                        <!-- <li data-value="agency" class="Filters_filterListItem">에이전시</li> -->
                                        <li data-value="others" class="Filters_filterListItem <%=(industry==7 ? "Filters_selected" : "")%>">기타</li>
                                    </ul>
                                </div>
                            </div>
                            <!-- <div class="FilterWithList_rightSide">
                                <div class="JndSelectBox_indSelectBox">
                                    <span class="JndSelectBox_selected">규모 전체</span>
                                    ul 쓰는 곳
                                    <ul class="dropdownList" style="display: none;">
                                        <li data-value="total" class="selectedBox">규모 전체</li>
                                        <li data-value="0to9" class>0-9명</li>
                                        <li data-value="10to49" class>10-49명</li>
                                        <li data-value="50to99" class>50-99명</li>
                                        <li data-value="100to499" class>100-499명</li>
                                        <li data-value="1000over" class>1,000명 이상</li>
                                    </ul>
                        ...
                        <div class="FilterWithList_cardListBox">
                            <ul class="CardList_cardList CardList_col3" style="/* margin: 0px -13px; */">
